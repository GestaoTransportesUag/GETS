...
class ModelsMotoristaTest < ActiveSupport::TestCase
  # test "the truth" do
  #   assert true
  # end
  ...
  test 'Nao deve salvar um motorista sem nome' do
    motorista = Motorista.new cpf:11111111111, telefone: 981380507
    assert_not motorista.save
  end

  test 'Nao deve salvar um motorista com cpf menor que 11 digitos' do
    motorista = Motorista.new cpf: 1111111111,nome: "Jose", telefone: 981380507
    assert_not motorista.save
  end
