...
class VeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post veiculos_url, params: { veiculo: { alocado: @veiculo.alocado, ano: @veiculo.ano, cor: @veiculo.cor, manutencaoEmDia: @veiculo.manutencaoEmDia, modelo: @veiculo.modelo, placa: @veiculo.placa, quilometragem: @veiculo.quilometragem } }
    end
  ...
  test "should update veiculo" do
    patch veiculo_url(@veiculo), params: { veiculo: { alocado: @veiculo.alocado, ano: @veiculo.ano, cor: @veiculo.cor, manutencaoEmDia: @veiculo.manutencaoEmDia, modelo: @veiculo.modelo, placa: @veiculo.placa, quilometragem: @veiculo.quilometragem } }
