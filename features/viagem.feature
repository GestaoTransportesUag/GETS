Feature: Veiculo
  ...
  Scenario: agendar corretamente uma viagem
    ...
    And eu preencho os campos de usuario com "Teste", veiculo com "HX576CA", motorista com "Marta", distancia percorrida com "0", finalidade com "Pesquisa", nome do requisitor com "Joaquim", funcao do requisitor com "professor", cpf do requisitor com "11111111111", numero de acompanhantes com "0", data de partida com "2020-11-15T08:00", data de chegada com "2020-11-15T20:00" e destino com "Angelim"
