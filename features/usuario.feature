Feature: Usuario
  ...
  Scenario: visualizar as informacoes de um usuario
    ...
    And eu vejo um usuario com nome "Teste123" ja existente
    And eu clico no botao com o nome "Teste123" referente ao usuario
    Then eu devo ver que o usuario com nome "Teste123" tem as informacoes corretas
  ...
  Scenario: cadastrar um usuario com CPF menor que 11
    ...
    And eu preencho os campos CPF com "7", nome com "Teste123", senha "123456", email "teste@gmail.com", telefone "99836613" e ativo
    And eu clico em Create Usuario
